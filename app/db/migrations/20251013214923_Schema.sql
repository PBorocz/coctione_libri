...
CREATE TABLE document (
    ...
    public_id TEXT,			 -- Public facing slug (generated as a sqid)
    fileid    TEXT,                       -- Wasabi file object identifier WONT NEED!
    filename  TEXT,                       -- WONT NEED!
    filesize  INTEGER DEFAULT 0,          -- Wasabi - WONT NEED!
